describe("helpers", () => {
  it("should computer intersection of edit range", () => {

  });
});

/*
import { createLine, updateText } from "../../../src/text/chunks/actions";
import {
  allLineVersionsReducer,
  lineVersionsByIdReducer,
  allLinesReducer,
  linesByIdReducer
} from "../../../../src/text/chunks/reducers";
import { AllLineVersions, AllLines } from "../../../../src/text/chunks/types";
