import { SourceType } from "../../../src/code/types";
import { getPartialProgram } from "../../../src/selectors/code/partial-program";
import {
  createChunks,
...
describe("getPartialProgram", () => {
  it("should have adjusted selections", () => {
    ...
    const state = createStateWithUndoable(code);
  ...
  describe("selected chunk version", () => {
    it("should have a selected chunk version", () => {
      const state = createStateWithChunks({ chunkVersionId: "chunk-version-0", line: 1 });
